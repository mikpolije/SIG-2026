...
<div class="header-puskesmas">
    ...
    <div>
        ...
        <small>Edit data puskesmas dengan benar</small>
    </div>
</div>
...
style="display:none;">
    ...
    <div class="header-posyandu">
        ...
        <div>
            ...
            <small>
                Edit data posyandu dengan benar
            </small>
...
========================= -->
<div class="modal-puskesmas" id="modal-update-puskesmas">
...
MODAL UPDATE POSYANDU
========================= -->
<div class="modal-puskesmas" id="modal-update-posyandu">
