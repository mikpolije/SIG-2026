...
<div class="question-block">
    ...
    <div class="answer-group">
        <input type="radio" id="ya<?= $i ?>" name="q<?= $i ?>" value="1" required>
        <label for="ya<?= $i ?>" class="answer-btn">Iya</label>

        <input type="radio" id="tidak<?= $i ?>" name="q<?= $i ?>" value="0">
        <label for="tidak<?= $i ?>" class="answer-btn">Tidak</label>
    </div>
