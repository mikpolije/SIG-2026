...
<div class="form-pegawai-page">
    ...
    <form action="<?= base_url('index.php/pneumonia/pegawai/update/' . $petugas['id_petugas']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="form-box">
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="password" class="form-control" value="<?= esc($petugas['password']) ?>">
                </div>
        ...
        <a href="<?= base_url('index.php/pneumonia/pegawai') ?>" class="btn-kembali">
            Kembali
        </a>
