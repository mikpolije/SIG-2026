...
<!-- SEARCH -->
<form method="get" action="<?= base_url('pneumonia/funfact') ?>">
...
<a href="<?= base_url('pneumonia/funfact?status=Publish') ?>"
...
<a href="<?= base_url('pneumonia/funfact?status=Draft') ?>"
...
<a href="<?= base_url('pneumonia/funfact/create') ?>"
...
<a href="<?= base_url('pneumonia/funfact/detail/'.$row['id_funfact']) ?>"
...
<a href="<?= base_url('pneumonia/funfact/edit/'.$row['id_funfact']) ?>"
class="btn btn-sm"
...
function publishFunfact(id){
    ...
    '<?= base_url('pneumonia/funfact/publish/') ?>'+id;
}
...
<a href="<?= base_url('pneumonia/funfact/detail/'.session()->getFlashdata('last_id')) ?>" class="btn-main">
Lihat Tampilan
</a>
...
<a href="<?= base_url('pneumonia/funfact/create') ?>" class="btn-main">
Lengkapi Data
</a>
